...
export default function Footer() {
  return (
    <footer className="border-t border-[#30363d] bg-[#0d1117]/60 backdrop-blur-sm mt-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#1f6feb] to-[#a371f7] flex items-center justify-center">
